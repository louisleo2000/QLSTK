@extends('layouts.dashboard.layout', ['title' => "Thông tin cá nhân",'active'=>3])

@section('content')
    @include('users.partials.header', [
        'title' => __('Xin chào') . ' '. auth()->user()->name,
        'description' => __('Chào mừng bạn đến với quản lý gia phả!! Đây là thông tin cá nhân của bạn, bạn có thể thay đổi chúng tùy thích'),
        'class' => 'col-lg-7'
    ])   
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Mật khẩu</h6>
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-password-confirmation">Xác nhận mật khẩu</label>
                                    <input type="password" name="password_confirmation" id="input-password-confirmation" class="form-control form-control-alternative" placeholder="{{ __('Confirm New Password') }}" value="" required>
                                </div>

                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4">Đổi mật khẩu</button>
                                </div>
                            </div>
                        </form>
                    </div>
